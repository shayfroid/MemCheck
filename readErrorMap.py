...
def readerrormap(filepath):
	...
	while line:
		...
		# print(f'{iteration}:{np.count_nonzero(m)}')
		# if iteration > 2:
		# 	break
		# print(f"finished reading line {iteration}")
...
if __name__ == '__main__':
	import sys
	t1 = time.clock()
	readerrormap(sys.argv[1])
	print(f'Elapsed time: {time.clock()-t1}')
